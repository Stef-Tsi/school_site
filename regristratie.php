...
<div class="slider">
    ...
    <section class="hero">
        <div class="content">
            <div id="containercv">
                <h1 style="color: rgba(0,255,50,0.78)">&bull; Registratie &bull;</h1>
                <div class="underline">
                </div>
                ...
                <form action="#" method="post" id="contact_form">
                    ...
                    <div class="LID">
                        <label for="name"></label>
                        <input type="text" placeholder="leerling ID" name="SID" id="SID" required>
                    </div>
                    <div class="email">
                        <label for="name"></label>
                    ...
                    <div class="subject">
                        ...
                        <select placeholder="Geplaatste klas" name="klas" id="klas" required style="color: rgba(0,255,50,0.78)">
                            <option disabled hidden selected>Geplaatste klas</option>
                            <option name="klas" value="1" style="background: #004971">IB1A</option>
                            <option name="klas" value="2" style="background: #004971">IB1B</option>
                            <option name="klas" value="3" style="background: #004971">IB1C</option>
                            <option name="klas" value="4" style="background: #004971">IB1D</option>
                    ...
                    <div class="message">
                        ...
                        <textarea name="message" placeholder="Extra opmerking" id="message_input" cols="30" rows="5"></textarea>
                    </div>
                    <div class="submit">
                        <input type="submit" value="Opslaan" name="btn" id="form_button" />
                    </div>
                </form><!-- // End form -->
            </div><!-- // End #container -->
...
if(isset($_POST['btn'])) {
    ...
    $query = "INSERT INTO students (SID, naam, achternaam, klas_id, email, message)".
        "VALUES ('$vnummer', '$vnaam', '$anaam', '$klas', '$mail', '$mes')";
